...
public class BasConstants {
	...
	/** 科目发生额类型:  5:结算金额 */
	public final static String SUB_AMT_TYPE_SETTLE = "5";
	...
	/** 科目方向: 4:付款方标准账户 */
    public final static String SUB_DIR_PAY_STD = "4";
    /** 科目方向: 5:收款方标准账户   */
    public final static String SUB_DIR_REC_STD = "5";
	...
	/** 处理状态	STATUS	5:冲正 */
	public static final String STATUS_REVERSE = "5";
    ...
    /** 清算类型：对公 */
    public static final String STL_TYPE_PUBLICK = "1";
    /** 清算类型：对私 */
    public static final String STL_TYPE_PRIVATE = "0";
    ...
    /** 商户账户长度 */
    public final static int    MERCHANT_ACC_CODE_LENGTH   = 10;
    /** 个人账户长度 */
    public final static int    INDIVIDUAL_ACC_CODE_LENGTH = 12;
